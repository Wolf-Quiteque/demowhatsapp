              ...
              >
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    ...
                    <button type="button" className="btn btn-warning" onClick={()=> {reprovar(); setShowModal(false)}} >
                          Reprovar
                      </button>
                      <button type="button" className="btn btn-success" onClick={()=> {aprovar(); setShowModal(false)}}>
                        Aprovar
                      </button> <button type="button" className="btn btn-danger" onClick={()=> setshowModalEliminar(true)}>
                        Eliminar
                      </button>
                      <button
                        type="button"
              ...
              >
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                <h3>
                  <p> <span className="text-danger">Eliminar</span> {membro && membro.nome} ?</p>
                </h3>
              </div>
              <div className="modal-footer">
                <button
