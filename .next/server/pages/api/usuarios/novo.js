...
/* harmony export */   "Z": () => (/* binding */ makeid)
/* harmony export */ });
function makeid() {
  var text = "";
...
/* harmony import */ var _lib_random__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(665);
...
async function handler(req, res) {
  ...
  const userpassword = (0,_lib_random__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)();
  const hashedPassword = await (0,_lib_auth__WEBPACK_IMPORTED_MODULE_0__/* .hashPassword */ .c_)(userpassword);
  data.password = hashedPassword;
  data.createdAt = new Date(now.getTime() + 1);
  const response = await db.collection("usuarios").insertOne(data);

  try {
    const emailResponse = await (0,_email_em__WEBPACK_IMPORTED_MODULE_2__.sendEmailAndAppend)({
...
var __webpack_exports__ = __webpack_require__.X(0, [7513,6836], () => (__webpack_exec__(9921)));
