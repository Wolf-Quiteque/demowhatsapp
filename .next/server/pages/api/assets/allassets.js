...
(() => {
var exports = {};
exports.id = "pages/api/assets/allassets";
exports.ids = ["pages/api/assets/allassets"];
exports.modules = {
...
/***/ "(api)/./pages/api/assets/allassets.js":
/*!***************************************!*\
  !*** ./pages/api/assets/allassets.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../lib/mongodb */ \"(api)/./lib/mongodb.js\");\n\nasync function handler(req, res) {\n    if (req.method !== \"POST\") {\n        return;\n    }\n    var data = req.body;\n    const client = await _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    const db = client.db(\"anje\");\n    try {\n        const response = await db.collection(\"assets\").find(data).toArray();\n        res.status(200).json(response);\n    } catch (error) {\n        console.log(error);\n        res.status(422).json({\n            message: \"Houve um erro!\"\n        });\n    }\n}\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handler);\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/assets/allassets.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/assets/allassets.js"));
